...
function initialize(){
  ...
  event_reg = new google.maps.Data();
  event_reg.loadGeoJson('act/eve.php?id='+id.value);
  event_reg.setMap(map);
  event_reg.setStyle({
    fillColor: 'red',
    strokeColor: 'red'
  ...
  event_reg.addListener('addfeature', function(e) {
