...
while($rows = mysqli_fetch_array($hasil2)){
  $pointid_travel=$rows['id'];
  $pointfullname=$rows['fullname'];
  $pointcp=$rows['cp'];
  $pointcity_name=$rows['city_name'];
  $pointaddress=$rows['address'];
  $pointwebsite=$rows['website'];
  $pointopen=$rows['open'];
  $pointclose=$rows['close'];
  $pointdescription=$rows['description'];
  $pointemail=$rows['email'];
...
//echo "$id_travel,$name,$cp,$address";
  ?>
          ...
          <tbody  style='vertical-align:top;'>
            <tr><td width="150px"><b>Travel Agent Name</b></td><td> :&nbsp; </td><td style='text-transform:capitalize;'><?php echo $pointfullname ?></td></tr>                
            <tr><td width="150px"><b>Contact Person</b></td><td> :&nbsp; </td><td style='text-transform:capitalize;'><?php echo $pointcp ?></td></tr>  
            <tr><td width="150px"><b>Address</b></td><td> :&nbsp; </td><td style='text-transform:capitalize;'><?php echo $pointaddress ?></td></tr>  
               <tr><td><b>City<b> </td><td>: </td><td><?php echo $pointcity_name?></td></tr>
            <tr><td width="150px"><b>Open Hour</b></td><td> :&nbsp; </td><td style='text-transform:capitalize;'><?php echo $pointopen ?></td></tr>  
            <tr><td width="150px"><b>Close Hour</b></td><td> :&nbsp; </td><td style='text-transform:capitalize;'><?php echo $pointclose ?></td></tr>
            <tr><td width="150px"><b>Website</b></td><td> :&nbsp; </td><td style='text-transform:capitalize;'> 
            <?php echo $pointwebsite ?></td></tr>   
            
            <tr><td width="150px"><b>Email</b></td><td> :&nbsp; </td><td style='text-transform:capitalize;'><?php echo $pointemail ?></td></tr>    
            <tr><td width="150px"><b>Description</b></td><td> :&nbsp; </td><td style='text-transform:capitalize;'><?php echo $pointdescription ?></td></tr>  
    ...
    while($baris = mysqli_fetch_assoc($hasil))
      {
        ...
        {
                echo "<a href='foto/".$baris['gallery_travel']."'><img width='200px' src='foto/".$baris['gallery_travel']."'></a>";
        }
      }
